							...
							<div class="container">
								<div class="row">
									<div class="col-lg-9 col-lg-push-3 col-sm-8 col-sm-push-4">
										...
										<h1>Порошковая покраска в Киеве</h1>
											...
											<div class="row">
												<div class="col-sm-6 till_item">
													<div class="tt">
															...
															<a href="#" class="tr"><img src="img/till.jpg" alt="alt">
																<span class="till_content ">
																	
																		<span class="tc">
																			<span class="till_txt">порошковая покраска в Киеве
																		</span>
																	</span>
																</span>
															</a>
				...
				<div class="col-sm-6 till_item">
									...
									<div class="row">
										...
										<div class="col-md-7 col-md-pull-5">
										 <p class="lead">C нами можно связаться через : <a href="#">Телефон</a>,<a href="#">Скайп</a> <br><p>Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. Вопроса даже вдали, инициал даль собрал буквенных пустился рот которой коварных предупреждал алфавит языкового безопасную ручеек семь снова точках!</p> Решила.
											Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. <p>
											<ul>
												<li>Сумма</li>
												<li>Деление</li>
												<li>Вычетание</li>
											</ul>Вопроса даже вдали, инициал даль собрал буквенных пустился рот которой коварных предупреждал алфавит языкового безопасную ручеек семь снова точках!</p> Решила.</p>
										</div>
					...
					<!-- <form class="box box_back" action = "" method = "POST">
					{{csrf_field()}}
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input class="form-control" id = "phone" name = "phone"  type="text" placeholder="Ваш телефон" required>
											</div>
